...
public class IZ3Transfer_String_length implements IZ3Transfer {
	...
	public String transfer(Constraint cons) throws JSONException {
		// TODO Auto-generated method stub
		savetoJson(cons);
		return String.format("length(%s) %s -- %s", cons.getSource().toZ3(), cons.getCondition(), cons.isSatisfy());
	}
	...
	public void savetoJson(Constraint cons) throws JSONException {
		...
		js.append("consName", "String_length");
		js.append("consArg", "");
